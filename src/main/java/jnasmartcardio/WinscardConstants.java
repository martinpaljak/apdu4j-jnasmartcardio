...
class WinscardConstants {
    ...
    // Starting from javadoc at https://pcsclite.apdu.fr/api/pcsclite_8h.html
    ...
    // Windows value for SCARD_E_UNSUPPORTED_FEATURE, pcsc-lite uses 0x8010001F
    public static final int SCARD_E_UNSUPPORTED_FEATURE_WIN = 0x80100022;
    ...
    public static final int SCARD_E_READ_ONLY_CARD = 0x80100034;
    ...
    static {
        ...
        a.put(SCARD_S_SUCCESS, "SCARD_S_SUCCESS"); b.put(SCARD_S_SUCCESS, "error codes from https://learn.microsoft.com/en-us/windows/win32/secauthn/authentication-return-values");
        ...
        a.put(SCARD_E_UNSUPPORTED_FEATURE_WIN, "SCARD_E_UNSUPPORTED_FEATURE"); b.put(SCARD_E_UNSUPPORTED_FEATURE_WIN, "This smart card does not support the requested feature.");
        a.put(SCARD_E_READ_ONLY_CARD, "SCARD_E_READ_ONLY_CARD"); b.put(SCARD_E_READ_ONLY_CARD, "The smart card is read only and cannot be written to.");
