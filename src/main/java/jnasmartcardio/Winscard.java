...
class Winscard {
     ...
     *
     * <p>
     * Packing pragmas: <a href=
     * "https://gcc.gnu.org/onlinedocs/gcc/Structure-Layout-Pragmas.html">GCC
     * structure-layout pragmas</a>
     */
    ...
    public static WinscardLibInfo openLib() {
        ...
        WinscardLibrary lib = Native.load(libraryName, WinscardLibrary.class, options);
